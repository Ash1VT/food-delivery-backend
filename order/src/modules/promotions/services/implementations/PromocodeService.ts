...
import { PromocodeMaximumUsageError, PromocodeNotFoundWithIdError } from "../../errors/promocode.errors";
...
export default class PromocodeService extends BaseService implements IPromocodeService {
