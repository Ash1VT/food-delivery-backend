...
import { orderItemCreateValidator, orderItemUpdateValidator } from "../validators/orderItem.validators"
...
export const updateOrderItem = async (req: Request, res: Response) => {
    ...
    const orderItemUpdateOutputDto = await orderItemService.updateOrderItem(orderId, orderItemId, orderItemUpdateInputDto)
    
    res.json(orderItemUpdateOutputDto)
}
