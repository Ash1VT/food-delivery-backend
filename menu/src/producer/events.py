...
class MenuItemCreatedEvent(ProducerEvent):
    """
    Event that is published when a menu item is created.
    """

    _topics_schemas = dict()


class MenuItemUpdatedEvent(ProducerEvent):
    """
    Event that is published when a menu item is updated.
    """

    _topics_schemas = dict()


class MenuItemDeletedEvent(ProducerEvent):
    """
    Event that is published when a menu item is deleted.
    """
